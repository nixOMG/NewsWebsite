...
public class WebController extends HttpServlet {
    ...
    @Override
   	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        String servletPath = request.getServletPath();
   		...
   		if(servletPath.equals("/login") || servletPath.equals("/register") || action != null && action.equals("sign-in")) {
   		...
   		else if ((servletPath.equals("/gallery") || servletPath.equals("/gallery.jsp")) && action != null && action.equals("gallery")) {
    ...
    private void handleForgotPass(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException {
		request.setCharacterEncoding("UTF-8");
	    response.setCharacterEncoding("UTF-8");
    ...
    if (email.trim() != null && username.trim() != null && password.trim() != null ) {
        ...
        if (userDb.getUserByEmail(email) == null) {
            ...
            //0- Not activated, 1-Admin, 2-Editor, 3-Writer, 4-Subscriber, 5-User
            ...
            request.getSession().setAttribute("form", "register");
            request.setAttribute("errorMessage2", "Your email address has already been used during a previous registration process,"
