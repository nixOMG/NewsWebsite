    ...
    <%@ page import="javax.servlet.http.HttpSession" %>
        <%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
            ...
            <%@ taglib uri="http://java.sun.com/jsp/jstl/functions" prefix="fn" %>
                ...
                <head>
                    <title>NewsFeed | Buy Subscription</title>
                    <meta charset="utf-8">
...
<stripe-buy-button
  ...
  buy-button-id="buy_btn_1PGdlSP4jfwpn2uAd2nQhhv9"
  publishable-key="pk_test_51PGdh1P4jfwpn2uASDtkroY7Ya8kMCNAN0EHPzx1LXUZxbKbxAGySHjK34qibBKYonpmTGIvQSkaF5NAW92O0965003IakjsHS"
>
</stripe-buy-button>

<script>
  document.addEventListener("DOMContentLoaded", function() {
    var stripeBuyButton = document.getElementById('stripe-buy-button');
    stripeBuyButton.addEventListener('click', function() {
      var buyButtonId = stripeBuyButton.getAttribute('buy-button-id');
      var publishableKey = stripeBuyButton.getAttribute('publishable-key');
