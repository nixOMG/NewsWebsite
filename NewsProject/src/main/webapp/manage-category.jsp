...
<head>
<title>NewsFeed | Editor | Manage Category</title>
<meta charset="utf-8">
					...
					<aside class="right_content">
						<div class="single_sidebar">
							<button class="btn btn-green"
								onclick="window.location.href='manage-category?action=get-page-add-category'">Add
								new category</button>
										...
										<tbody>
										    <c:forEach var="category" items="${categories}" varStatus="loop">
										        <tr>
										            ...
										            <td>
										                <button class="btn btn-blue" style="width: 100px;"
										                    onclick="window.location.href='manage-category?action=get-page-add-child-category&parentCategoryId=${category.categoryId}'">
										                    Add Child
										                </button>
										                <button class="btn btn-red deleteBtn" style="width: 100px;" data-category-id="${category.categoryId}">
										                    Delete
										                </button>
										            </td>
										            <td>
							                            <c:forEach var="child" items="${category.children}">
							                                <h6>
								                              	 <button class="deleteBtn" style="margin-right: 30px;" data-category-id="${child.categoryId}">
							                                        Delete
							                                	</button>
