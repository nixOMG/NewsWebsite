      ...
      <div class="col-lg-12 col-md-12 col-sm-12">
        <div class="left_content">
          <div class="contact_area">
            ...
            <form action="manage-chapter" method="post" class="contact_form" enctype="multipart/form-data" accept-charset="UTF-8">
              <input type="hidden" name="action" value="add-chapter"/>
              ...
              <label for="describe" class="form-label">Content:</label>
...
<!-- bị lỗi chỗ lastest new <script src="https://code.jquery.com/jquery-3.7.1.min.js" integrity="sha256-/JqT3SQfawRcv/BIHPThkBvs0OEvtFFmqPF/lYI/Cxo=" crossorigin="anonymous"></script>
...
$(document).ready(function () {
    ...
    $('#image').change(function () {
        ...
        var promises = $.map(files, function(file) {
            ...
            return $.ajax({
                url: '/NewsProject/upload-image?uuid='+uuid,
                type: 'POST',
                data: formData,
                contentType: false,
                processData: false
