								...
								<div class="col-lg-12 col-md-12 col-sm-12">
								    <aside class="right_content">
								        <div class="single_sidebar">
								        	<button class="btn btn-green" onclick="window.location.href='manage-articles?action=get-page-add-article'">Add new article</button>
								        
								            <h2><span>Your articles</span></h2>
											    ...
											    <table class="table">
											        <thead>
														<tr class="table-header">
														    <td style="width: 10%;"><h4>ID</h4></td>
														    <td style="width: 45%;"><h4>Title</h4></td>
														    <td style="width: 10%;"><h4>Status</h4></td>
														    <td style="width: 10%;"><h4>Category</h4></td>
														    <td style="width: 10%;"><h4>Tags</h4></td>
														    <td style="width: 15%;"><h4>Actions</h4></td>
											        ...
											        <c:forEach var="article" items="${articles}" varStatus="loop">
											            <tr>
											                <td><h5><c:out value="${article.articleId}" /></h5></td>
											                <td><h5><c:out value="${article.title}" /></h5></td>
											                <td><h5><c:out value="${article.status}" /></h5></td>
					                						<td><h5><c:out value="${article.category.description}" /></h5></td>
											                <td>
													            <c:forEach var="tag" items="${article.tags}">
													                <h5><c:out value="${tag.name}, " /></h5>
													            </c:forEach>
													        </td>
											                <td>
											                    <button class="btn btn-yellow" onclick="window.location.href='manage-articles?action=get-page-edit-article&articleId=${article.articleId}'">Edit</button>
											                    <button class="btn btn-red" onclick="window.location.href='manage-articles?action=get-page-delete-article&articleId=${article.articleId}'">Delete</button>
											                </td>
											            </tr>
											        </c:forEach>
											        </tbody>
									        ...
									        <ul class="pagination">
									            <c:forEach begin="1" end="${totalPages}" var="page">
									                <li class="<c:if test="${page == pageNumber}">active</c:if>">
									                    <a class="page-link" href="manage-article?page=${page}">${page}</a>
									                </li>
									            </c:forEach>
									        </ul>
							            </c:if>
