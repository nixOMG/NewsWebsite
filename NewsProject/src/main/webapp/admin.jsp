						...
						<li class="dropdown user user-menu"><a href="#"
							...
							<ul class="dropdown-menu">
								...
								<li class="user-footer">
									<div class="pull-left">
										<a href="admin?action=get-page-edit-account&userId=${loggedInUser.getUserId()}" class="btn btn-default btn-flat">Profile</a>
									</div>
		...
		<div class="content-wrapper">
			...
			<section class="content">
				...
				<div class="box">
					...
					<div class="box-body">Welcome to Admin page</div>
					<!-- /.box-body -->
