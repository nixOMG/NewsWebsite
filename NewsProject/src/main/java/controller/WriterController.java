...
public class WriterController extends HttpServlet {
	...
	private void getPageAddArticle(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			RequestDispatcher dispatcher = request.getRequestDispatcher("add-article-writer.jsp");
			dispatcher.forward(request, response);
		} catch (Exception e) {
			e.printStackTrace();
			RequestDispatcher dispatcher = request.getRequestDispatcher("error.jsp");
	...
	private void getPageEditArticle(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			if (article != null && categories != null && tags != null) {
				...
				RequestDispatcher dispatcher = request.getRequestDispatcher("edit-article-writer.jsp");
				dispatcher.forward(request, response);
			} else {
	...
	private void getPageDeleteArticle(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			if (article != null && categories != null && tags != null) {
				...
				RequestDispatcher dispatcher = request.getRequestDispatcher("delete-article-writer.jsp");
				dispatcher.forward(request, response);
			} else {
	...
	private void getArticlesPaginated(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			try {
				...
				RequestDispatcher dispatcher = request.getRequestDispatcher("/manage-article-writer.jsp");
				dispatcher.forward(request, response);
			} catch (Exception e) {
				e.printStackTrace();
			} finally {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		if (user != null && (user.getRole().getRoleId() == 4)) {
			if (action != null && action.equals("add-article-writer")) {
				handleAddArticle(request, response);
			} else if (action != null && action.equals("edit-article-writer")) {
				handleEditArticle(request, response);
			} else if (action != null && action.equals("delete-article-writer")) {
